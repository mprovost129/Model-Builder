...
test("round-trips a versioned multi-box project without dimensional drift", () => {
  ...
  assert.equal(parsed.project.version, 19);
...
test("opens legacy version-1 through version-7 projects and upgrades them", () => {
  ...
  legacyVersion3.version = 3 as 19;
  ...
  legacyVersion4.version = 4 as 19;
  ...
  legacyVersion5.version = 5 as 19;
  ...
  legacyVersion6.version = 6 as 19;
  ...
  legacyVersion7.version = 7 as 19;
...
test("rejects malformed, unrelated, and future files", () => {
  ...
  const future = parseProjectDocument(JSON.stringify({ ...project, version: 20 }));
...
test("round-trips Circles and upgrades version-9 projects without Circle data", () => {
  ...
  assert.equal(upgraded.project.version, 19);
