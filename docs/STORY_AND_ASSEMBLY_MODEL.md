...
- **Finished Ceiling** is the rough ceiling minus the ceiling-finish assembly.
...
Finished Ceiling = Rough Ceiling - Ceiling Finish Thickness
...
- Version-15 project files store the Building Datum, ordered Stories, active and
  anchored Story identities, all floor and wall assembly layers, entity Story
  ownership, floor-platform footprints, and Wall type assignments.
...
- Rough height, datum elevation, structural layers, and finish layers are editable.
...
- `W` or Model > Wall draws straight, layered Walls with the same exact input,
  ...
  and rough ceiling.
- Manage > Wall Types edits reusable exterior-to-interior layered assemblies.
...
3. Add automatic wall corner cleanup, joins, openings, and layer-reference control.
